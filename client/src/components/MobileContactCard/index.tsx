...
function MobileContactCard({
  ...
  return (
    <div className="flex place-items-center bg-gray-700 flex-col mx-5 my-3 text-gray-500 p-5 hover:scale-105 transition ease-linear duration-100 group space-y-1">
